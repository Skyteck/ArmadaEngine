...
namespace ArmadaEngine.UI
{
    public class UIPanel : UIElement
    {
        ...
        public void Update(GameTime gt)
        {
            ...
            {
                if (Helpers.InputHelper.LeftButtonReleased)
                {
                ...
                {
                    scrollPos = 0;
                    Vector2 currentPos = Helpers.InputHelper.MouseScreenPos;
                    Vector2 prevPos = Helpers.InputHelper.PrevMouseScreenPos;
            ...
            else if (trackMove)
            {
                ...
                if (Helpers.InputHelper.RightButtonReleased)
                {
                    trackMove = false;
                }
                else
