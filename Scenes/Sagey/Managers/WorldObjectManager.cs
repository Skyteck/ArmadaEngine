...
namespace ArmadaEngine.Scenes.Sagey.Managers
{
    public class WorldObjectManager
    {
        ...
        public WorldObjectManager(TileMaps.TilemapManager mapManager,  InventoryManager invenManager, ContentManager content, GameObjects.Player player, ItemManager im)
        {
